      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-5rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,1.08fr)_minmax(380px,0.92fr)]">
        <section className="hidden lg:block">
          <Link href="/" className="inline-flex items-center gap-2.5">
            <BrandMark className="animate-pulse-glow flex h-10 w-10 items-center justify-center rounded-xl border border-[#79e5d2]/30 bg-[linear-gradient(135deg,rgba(121,229,210,0.9),rgba(207,255,246,0.92))] text-[#041117]" />
            <span className="brand-display text-[1.6rem] leading-none tracking-tight text-white">
              LifePage
            </span>
          </Link>
