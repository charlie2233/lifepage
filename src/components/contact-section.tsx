        ...
        <div className="lp-panel grid gap-6 rounded-[2rem] p-6 md:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] md:p-8">
          <div className="rounded-[1.75rem] border border-white/10 bg-[linear-gradient(180deg,rgba(121,229,210,0.12),rgba(255,255,255,0.03))] p-6">
            ...
            <h2 className="brand-display mt-3 text-4xl tracking-tight text-[#f8f3ea]">
              Need product help, a demo, or a serious partnership conversation?
            </h2>
            <p className="mt-4 text-sm leading-7 text-[#97a4ae]">
              Send a note and we will get back to you about onboarding, school or career use cases,
              creator workflows, bug reports, or custom deployment questions.
            </p>
            ...
            <div className="mt-8 space-y-3 text-sm text-[#dde4e9]">
              <div className="card-hover rounded-2xl border border-white/10 bg-black/20 p-4 transition-colors hover:border-white/20 hover:text-white">
                Product support, onboarding, and product feedback
              </div>
              <div className="card-hover rounded-2xl border border-white/10 bg-black/20 p-4 transition-colors hover:border-white/20 hover:text-white">
                Partnerships, campus pilots, and creator programs
              </div>
              <div className="card-hover rounded-2xl border border-white/10 bg-black/20 p-4 transition-colors hover:border-white/20 hover:text-white">
                Custom domains, deployment, and AI workflow design
              </div>
            </div>
